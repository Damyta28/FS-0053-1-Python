...
print("\nEsto es una lista de diccionario dentro de otro diccionario (JSON)")
print(data_json)
print()
...
# Que pasa si la clave no existe
...
print( f"La nueva dedad del estudiante es: {estudiante.get('edad')}")
